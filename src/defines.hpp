...
#define GRAPHICS_U_MAX 0.05f // maximum velocity for velocity coloring in units of LBM lattice speed of sound (c=1/sqrt(3)) (default: 0.18f) - REDUCED to make velocity field less overwhelming
